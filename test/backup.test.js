...
function assertRowsMatchFile(db, backupName, done) {
  var db2 = new sqlite3.Database(backupName, sqlite3.OPEN_READONLY, function(
    err
  ) {
    if (err) throw err;
...
describe("backup", function() {
  ...
  (sqlite3.VERSION_NUMBER < 3026000 ? it.skip : it)(
    "can backup from temp to main",
    function(done) {
          ...
          var backup = db.backup(
            ...
            function(err) {
              ...
              backup.step(-1, function(err) {
                ...
                backup.finish(function(err) {
                  if (err) throw err;
                  var db2 = new sqlite3.Database("test/tmp/backup.db", function(
                    err
                  ) {
                    if (err) throw err;
  ...
  // Test failing with sqlcipher currently.
  (sqlite3.VERSION_NUMBER < 3026000 ? it.skip : it.skip)(
    "can backup from main to temp",
    function(done) {
      var backup = db.backup(
        "test/support/prepare.db",
        "main",
